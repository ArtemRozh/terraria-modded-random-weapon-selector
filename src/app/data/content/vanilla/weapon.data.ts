...
export const vanillaWeaponData = [
      {name: 'Acorn Slingshot', image: 'https://terraria.wiki.gg/images/Acorn_Slingshot.png?b38c9c', tier: [Boss.PreBoss], tags: [VanillaTag.FinalUpdate], class: 'Classless', rarity: 'Lime'},//
 {name: 'Slime Spear', image: 'https://terraria.wiki.gg/images/Slime_Spear.png?29158e', tier: [Boss.KingSlime], tags: [VanillaTag.FinalUpdate], class: 'Melee', rarity: 'White'},//
 {name: 'Axearang', image: 'https://terraria.wiki.gg/images/Axearang.png?19b49d', tier: [Boss.PreBoss], tags: [VanillaTag.FinalUpdate], class: 'Melee', rarity: 'Light Red'},//
 {name: 'True Copper Shortsword', image: 'https://terraria.wiki.gg/images/True_Copper_Shortsword.png?e89a29', tier: [Boss.EvilBoss, Boss.QueenBee, Boss.Skeletron, Boss.MoonLord], tags: [VanillaTag.FinalUpdate], class: 'Melee', rarity: 'Red'},//
 {name: 'Pretty Mirror', image: 'https://terraria.wiki.gg/images/Pretty_Mirror.png?5ba1ed', tier: [Boss.Skeletron], tags: [VanillaTag.FinalUpdate], class: 'Classless', rarity: 'Blue'},//
 {name: 'Foxparks', image: 'https://terraria.wiki.gg/images/Foxparks.png?4c9c94', tier: [Boss.PreBoss], tags: [VanillaTag.FinalUpdate], class: 'Summon', rarity: 'Light Red'},//
 {name: 'Cattiva', image: 'https://terraria.wiki.gg/images/Cattiva.png?12c45c', tier: [Boss.PreBoss], tags: [VanillaTag.FinalUpdate], class: 'Summon', rarity: 'Pink'},//
 {name: 'Barnacle Staff', image: 'https://terraria.wiki.gg/images/Barnacle_Staff.png?91eaf2', tier: [Boss.WallOfFlesh], tags: [VanillaTag.FinalUpdate], class: 'Summon', rarity: 'Light Red'},//
 {name: 'Flint', image: 'https://terraria.wiki.gg/images/Flint.png?35330f', tier: [Boss.WallOfFlesh], tags: [VanillaTag.FinalUpdate], class: 'Melee', rarity: 'Light Red'},//
 {name: 'Killing Deck', image: 'https://terraria.wiki.gg/images/Killing_Deck.png?a7e0b3', tier: [Boss.WallOfFlesh], tags: [VanillaTag.FinalUpdate], class: 'Magic', rarity: 'Light Red'},//
 {name: 'Barrel Launcher', image: 'https://terraria.wiki.gg/images/Barrel_Launcher.png?64a9fa', tier: [Boss.WallOfFlesh], tags: [VanillaTag.FinalUpdate], class: 'Ranged', rarity: 'Light Red'},//
 {name: 'Mushroom Staff', image: 'https://terraria.wiki.gg/images/Mushroom_Staff.png?1d92f0', tier: [Boss.EvilBoss], tags: [VanillaTag.FinalUpdate], class: 'Summon', rarity: 'Green'},//
 {name: 'Possession', image: 'https://terraria.wiki.gg/images/Possession.png?6d3886', tier: [Boss.MoonLord], tags: [VanillaTag.FinalUpdate], class: 'Summon', rarity: 'Red'},//
 {name: 'Constellation', image: 'https://terraria.wiki.gg/images/Constellation.png?ea8c01', tier: [Boss.Cultist], tags: [VanillaTag.FinalUpdate], class: 'Summon', rarity: 'Yellow'},//
 {name: 'Electric Eel', image: 'https://terraria.wiki.gg/images/Electric_Eel.png?f6611d', tier: [Boss.Duke], tags: [VanillaTag.FinalUpdate], class: 'Summon', rarity: 'Yellow'},//
 {name: 'Vulgar Display of Flower', image: 'https://terraria.wiki.gg/images/Vulgar_Display_of_Flower.png?bec25c', tier: [Boss.Plantera], tags: [VanillaTag.FinalUpdate], class: 'Summon', rarity: 'Lime'},//
 {name: 'Starcrash', image: 'https://terraria.wiki.gg/images/Starcrash.png?72fd1c', tier: [Boss.EvilBoss], tags: [VanillaTag.FinalUpdate], class: 'Summon', rarity: 'Green'},//
 {name: 'Vasculash', image: 'https://terraria.wiki.gg/images/Vasculash.png?78cce7', tier: [Boss.PreBoss], tags: [VanillaTag.Crimson, VanillaTag.FinalUpdate], class: 'Summon', rarity: 'Blue'},//
 {name: 'Soulscourge', image: 'https://terraria.wiki.gg/images/Soulscourge.png?9706c3', tier: [Boss.PreBoss], tags: [VanillaTag.Corruption, VanillaTag.FinalUpdate], class: 'Summon', rarity: 'Blue'},//
 {name: 'Slime Whip', image: 'https://terraria.wiki.gg/images/Slime_Whip.png?de2680', tier: [Boss.KingSlime], tags: [VanillaTag.FinalUpdate], class: 'Summon', rarity: 'Blue'},//
 {name: 'Cobwhip', image: 'https://terraria.wiki.gg/images/Cobwhip.png?9c6067', tier: [Boss.PreBoss], tags: [VanillaTag.FinalUpdate], class: 'Summon', rarity: 'Blue'},//
 {name: 'Iron Broadsword', image: 'https://terraria.wiki.gg/images/Iron_Broadsword.png?b2b3bd', tier: [Boss.PreBoss], tags: [], class: 'Melee', rarity: 'White'},//
 ...
 {name: 'Demon Bow', image: 'https://terraria.wiki.gg/images/Demon_Bow.png?914ed9', tier: [Boss.PreBoss], tags: [VanillaTag.Corruption], class: 'Ranged', rarity: 'Blue'},//
 {name: 'Lights Bane', image: 'https://terraria.wiki.gg/images/Light%27s_Bane.png?7932b6', tier: [Boss.PreBoss], tags: [VanillaTag.Corruption], class: 'Melee', rarity: 'Blue'},//
 ...
 {name: 'Vilethorn', image: 'https://terraria.wiki.gg/images/Vilethorn.png?187463', tier: [Boss.PreBoss], tags: [VanillaTag.Corruption], class: 'Magic', rarity: 'Blue'},//
 ...
 {name: 'Musket', image: 'https://terraria.wiki.gg/images/Musket.png?11d540', tier: [Boss.PreBoss], tags: [VanillaTag.Corruption], class: 'Ranged', rarity: 'Blue'},//
 ...
 {name: 'Ball O Hurt', image: 'https://terraria.wiki.gg/images/Ball_O%27_Hurt.png?f7ad2a', tier: [Boss.PreBoss], tags: [VanillaTag.Corruption], class: 'Melee', rarity: 'Blue'},//
 ...
 {name: 'Phaseblade (Any)', image: 'https://terraria.wiki.gg/images/White_Phaseblade.png?1df291', tier: [Boss.EvilBoss], tags: [], class: 'Melee', rarity: 'Blue'},//
 ...
 {name: 'Phoenix Blaster', image: 'https://terraria.wiki.gg/images/Phoenix_Blaster.png?508d6f', tier: [Boss.Skeletron], tags: [], class: 'Ranged', rarity: 'Orange'},//
 ...
 {name: 'Nights Edge', image: 'https://terraria.wiki.gg/images/Night%27s_Edge.png?464d44', tier: [Boss.Skeletron], tags: [], class: 'Melee', rarity: 'Orange'},//
 ...
 {name: 'Flamethrower', image: 'https://terraria.wiki.gg/images/Flamethrower.png?13c55b', tier: [Boss.Prime], tags: [], class: 'Ranged', rarity: 'Pink'},//
 ...
 {name: 'Magic Dagger', image: 'https://terraria.wiki.gg/images/Magic_Dagger.png?87a45a', tier: [Boss.WallOfFlesh], tags: [], class: 'Magic', rarity: 'Light Red'},//
 ...
 {name: 'Keybrand', image: 'https://terraria.wiki.gg/images/Keybrand.png?54bbd7', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Melee', rarity: 'Yellow'},//
 ...
 {name: 'Tactical Shotgun', image: 'https://terraria.wiki.gg/images/Tactical_Shotgun.png?7dbf6e', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Ranged', rarity: 'Yellow'},//
 ...
 {name: 'Terra Blade', image: 'https://terraria.wiki.gg/images/Terra_Blade.png?6df328', tier: [Boss.EvilBoss, Boss.Skeletron, Boss.Plantera], tags: [], class: 'Melee', rarity: 'Yellow'},//
 ...
 {name: 'Rocket Launcher', image: 'https://terraria.wiki.gg/images/Rocket_Launcher.png?51f09c', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Ranged', rarity: 'Yellow'},//
 ...
 {name: 'Blood Butcherer', image: 'https://terraria.wiki.gg/images/Blood_Butcherer.png?460456', tier: [Boss.PreBoss], tags: [VanillaTag.Crimson], class: 'Melee', rarity: 'Blue'},//
 {name: 'Tendon Bow', image: 'https://terraria.wiki.gg/images/Tendon_Bow.png?20c619', tier: [Boss.PreBoss], tags: [VanillaTag.Crimson], class: 'Melee', rarity: 'White'},//
 {name: 'The Undertaker', image: 'https://terraria.wiki.gg/images/The_Undertaker.png?edd4e9', tier: [Boss.PreBoss], tags: [VanillaTag.Crimson], class: 'Ranged', rarity: 'Blue'},//
 {name: 'The Meatball', image: 'https://terraria.wiki.gg/images/The_Meatball.png?a97e42', tier: [Boss.EvilBoss], tags: [VanillaTag.Crimson], class: 'Melee', rarity: 'Blue'},//
 {name: 'The Rotted Fork', image: 'https://terraria.wiki.gg/images/The_Rotted_Fork.png?1033fd', tier: [Boss.PreBoss], tags: [VanillaTag.Crimson], class: 'Melee', rarity: 'Blue'},//
 ...
 {name: 'Shadewood Sword', image: 'https://terraria.wiki.gg/images/Shadewood_Sword.png?c46e60', tier: [Boss.PreBoss], tags: [VanillaTag.Crimson], class: 'Melee', rarity: 'White'},//
 {name: 'Shadewood Bow', image: 'https://terraria.wiki.gg/images/Shadewood_Bow.png?1b4cee', tier: [Boss.PreBoss], tags: [VanillaTag.Crimson], class: 'Ranged', rarity: 'White'},//
 ...
 {name: 'Piranha Gun', image: 'https://terraria.wiki.gg/images/Piranha_Gun.png?6378b9', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Ranged', rarity: 'Yellow'},//
 ...
 {name: 'Sniper Rifle', image: 'https://terraria.wiki.gg/images/Sniper_Rifle.png?2b7c13', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Ranged', rarity: 'Yellow'},//
 ...
 {name: 'Crimson Rod', image: 'https://terraria.wiki.gg/images/Crimson_Rod.png?919820', tier: [Boss.PreBoss], tags: [VanillaTag.Crimson, VanillaTag.Corruption], class: 'Magic', rarity: 'Blue'},//
 ...
 {name: 'Rainbow Gun', image: 'https://terraria.wiki.gg/images/Rainbow_Gun.png?53c145', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Magic', rarity: 'Yellow'},//
 ...
 {name: 'Shadowbeam Staff', image: 'https://terraria.wiki.gg/images/Shadowbeam_Staff.png?d4b02b', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Magic', rarity: 'Yellow'},//
 {name: 'Inferno Fork', image: 'https://terraria.wiki.gg/images/Inferno_Fork.png?978a42', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Magic', rarity: 'Yellow'},//
 {name: 'Spectre Staff', image: 'https://terraria.wiki.gg/images/Spectre_Staff.png?fda429', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Magic', rarity: 'Yellow'},//
 {name: 'Paladins Hammer', image: 'https://terraria.wiki.gg/images/Paladin%27s_Hammer.png?43da21', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Melee', rarity: 'Yellow'},//
 {name: 'S.D.M.G.', image: 'https://terraria.wiki.gg/images/S.D.M.G..png?a07de8', tier: [Boss.MoonLord], tags: [], class: 'Ranged', rarity: 'Red'},//
 {name: 'Vampire Knives', image: 'https://terraria.wiki.gg/images/Vampire_Knives.png?b16309', tier: [Boss.Skeletron, Boss.Plantera], tags: [VanillaTag.Crimson], class: 'Melee', rarity: 'Yellow'},//
 {name: 'Scourge of the Corruptor', image: 'https://terraria.wiki.gg/images/Scourge_of_the_Corruptor.png?58634c', tier: [Boss.Skeletron, Boss.Plantera], tags: [VanillaTag.Corruption], class: 'Melee', rarity: 'Yellow'},//
 {name: 'Staff of the Frost Hydra', image: 'https://terraria.wiki.gg/images/Staff_of_the_Frost_Hydra.png?c57fda', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Summon', rarity: 'Yellow'},//
 {name: 'Candy Corn Rifle', image: 'https://terraria.wiki.gg/images/Candy_Corn_Rifle.png?6f9511', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Ranged', rarity: 'Yellow'},//
 {name: 'Jack O Lantern Launcher', image: 'https://terraria.wiki.gg/images/Jack_%27O_Lantern_Launcher.png?34d0ab', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Ranged', rarity: 'Yellow'},//
 ...
 {name: 'Raven Staff', image: 'https://terraria.wiki.gg/images/Raven_Staff.png?66fb10', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Summon', rarity: 'Yellow'},//
 ...
 {name: 'The Horsemans Blade', image: 'https://terraria.wiki.gg/images/The_Horseman%27s_Blade.png?ed149b', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Melee', rarity: 'Yellow'},//
 ...
 {name: 'Christmas Tree Sword', image: 'https://terraria.wiki.gg/images/Christmas_Tree_Sword.png?e23863', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Melee', rarity: 'Yellow'},//
 ...
 {name: 'Razorpine', image: 'https://terraria.wiki.gg/images/Razorpine.png?9e6b5e', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Magic', rarity: 'Yellow'},//
 {name: 'Blizzard Staff', image: 'https://terraria.wiki.gg/images/Blizzard_Staff.png?875d80', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Magic', rarity: 'Yellow'},//
 {name: 'Snowman Cannon', image: 'https://terraria.wiki.gg/images/Snowman_Cannon.png?9825a3', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Ranged', rarity: 'Yellow'},//
 {name: 'North Pole', image: 'https://terraria.wiki.gg/images/North_Pole.png?26f5ec', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Melee', rarity: 'Lime'},//
 ...
 {name: 'Life Drain', image: 'https://terraria.wiki.gg/images/Life_Drain.png?7a8974', tier: [Boss.WallOfFlesh], tags: [VanillaTag.Crimson], class: 'Magic', rarity: 'Pink'},//
 {name: 'Dart Pistol', image: 'https://terraria.wiki.gg/images/Dart_Pistol.png?6361f2', tier: [Boss.WallOfFlesh], tags: [VanillaTag.Crimson], class: 'Ranged', rarity: 'Pink'},//
 {name: 'Dart Rifle', image: 'https://terraria.wiki.gg/images/Dart_Rifle.png?fbd34b', tier: [Boss.WallOfFlesh], tags: [VanillaTag.Corruption], class: 'Ranged', rarity: 'Pink'},//
 {name: 'Chain Guillotines', image: 'https://terraria.wiki.gg/images/Chain_Guillotines.png?af4d93', tier: [Boss.WallOfFlesh], tags: [VanillaTag.Corruption], class: 'Melee', rarity: 'Pink'},//
 {name: 'Fetid Baghnakhs', image: 'https://terraria.wiki.gg/images/Fetid_Baghnakhs.png?526e1b', tier: [Boss.WallOfFlesh], tags: [VanillaTag.Crimson], class: 'Melee', rarity: 'Pink'},//
 {name: 'Clinger Staff', image: 'https://terraria.wiki.gg/images/Clinger_Staff.png?ed897a', tier: [Boss.WallOfFlesh], tags: [VanillaTag.Corruption], class: 'Magic', rarity: 'Pink'},//
 ...
 {name: 'Toxikarp', image: 'https://terraria.wiki.gg/images/Toxikarp.png?f1227c', tier: [Boss.WallOfFlesh], tags: [VanillaTag.Crimson, VanillaTag.Corruption], class: 'Ranged', rarity: 'Pink'},//
 {name: 'Bladetongue', image: 'https://terraria.wiki.gg/images/Bladetongue.png?1a62bf', tier: [Boss.WallOfFlesh], tags: [VanillaTag.Crimson], class: 'Melee', rarity: 'Pink'},//
 ...
 {name: 'Malaise', image: 'https://terraria.wiki.gg/images/Malaise.png?14fb6d', tier: [Boss.PreBoss], tags: [VanillaTag.Crimson, VanillaTag.Corruption], class: 'Melee', rarity: 'Blue'},//
 {name: 'Artery', image: 'https://terraria.wiki.gg/images/Artery.png?b72d68', tier: [Boss.PreBoss], tags: [VanillaTag.Crimson], class: 'Melee', rarity: 'Blue'},//
 ...
 {name: 'Kraken', image: 'https://terraria.wiki.gg/images/Kraken.png?e07e05', tier: [Boss.Skeletron, Boss.Plantera], tags: [], class: 'Melee', rarity: 'Yellow'},//
 ...
 {name: 'Grenade (Any)', image: 'https://terraria.wiki.gg/images/Grenade.png?150ea5', tier: [Boss.PreBoss], tags: [], class: 'Ranged', rarity: 'Green'},//
 ...
 {name: 'Zenith', image: 'https://terraria.wiki.gg/images/Zenith.png?6d467f', tier: [Boss.EvilBoss, Boss.QueenBee, Boss.Skeletron, Boss.MoonLord], tags: [], class: 'Melee', rarity: 'Red'},//
 ...
 {name: 'Trimarang', image: 'https://terraria.wiki.gg/images/Trimarang.png?97d32b', tier: [Boss.PreBoss], tags: [], class: 'Melee', rarity: 'Orange'},//
 {name: 'Waffles Iron', image: 'https://terraria.wiki.gg/images/Waffle%27s_Iron.png?be4e57', tier: [Boss.MechBossRest], tags: [], class: 'Melee', rarity: 'Pink'},//
];